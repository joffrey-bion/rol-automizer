...
class RequestSender {
    ...
    String execute(HttpUriRequest request) {
        try {
            ...
            logger.error("Exception during HTTP request", e);
     ...
     */
    boolean execute(HttpUriRequest request, Predicate<String> responseSuccessful) {
     ...
     *         a handler to execute if the request was successful. It will be passed the response as a String.
     * @param failureHandler
     *         a handler to execute if the request was not successful. It will be passed the response as a String.
     *
     * @return the executed handler's return value
     */
    private <T> T execute(HttpUriRequest request, Predicate<String> responseSuccessful,
